...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOB, OLED_IIC_SCL_PIN, (BitAction)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	GPIO_WriteBit(GPIOB, OLED_IIC_SDA_PIN, (BitAction)BitValue);
...
************************************************************
*/
void OLED_Show_Pay_Mode(void){

    OLED_Clear();
    OLED_ShowString(39, 0, "SELECT",OLED_8X16);
	OLED_ReverseArea(0, 0, 127, 16);
    OLED_ShowChinese(31, 17,"应用支付");
    OLED_ShowChinese(31, 35,"卡片支付");
    /* 调用OLED_Update函数，将OLED显存数组的内容更新到OLED硬件进行显示 */
    OLED_Update();  
}
...
************************************************************
*/
void OLED_Show_App_Tip(void){

    OLED_Clear();
    OLED_ShowChinese(15, 10,"扫码下载");OLED_ShowString(80,10, "APP", OLED_8X16);
    OLED_ShowChinese(15, 26,"即可完成操作");
